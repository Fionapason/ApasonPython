...
names.conductivity = ["Diluate Conductivity";
                      "Concentrate Conductivity";
                      "Split Tank Conductivity"];
...
configuration.ls = [1; %lowest of the UF Tank
                    1; %highest of the ED Conc Tank
                    1; %middle of the ED Conc Tank
                    1; %middle of the ED Split tank
                    1; %Lowest of the ED Split tank
                    1; %ED Rinse
                    0];
