...
names.ocvNO = "ocvNO D44"; %D44 - wrong in the Teams Excel File !! - Had to do this because of the final electronicbox

names.ocvNC = "ocvNC D45"; %D45

names.cv = "cv D38"; %D38

%To say which ones are connected - NEW
configuration.ls = [1; % highest level switch of Feed -1
                    1; % middle level switch of Feed -2
                    1; % lowest level switch of Feed -3
                    1; % highest level switch of UF -4
                    1; % middle level switch of UF -5
                    1; % middle level switch of Purge -6
                    1];% highest level switch of Purge -7

% %OLD
% configuration.ls = [1; % highest level switch of the UF Tank -1 --> 4
%                     1; % middle level switch of the UF Tank -2 --> 5
%                     1; % highest level switch of Feed -3 --> 1
%                     1; % middle level switch of Feed -4 --> 2
%                     1; % low level switch of Feed -5 --> 3
%                     1; % highest level switch of Purge -6 -->7
%                     1];% middle level switch of Purge -7 -->6
